  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:car:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
              ...
              <el-tag  color=blue  >{{ scope.row.carlicencenum }}</el-tag>
                <p style="font-size:18px;font-weight:bold">{{ scope.row.vehicleid }}</p>
